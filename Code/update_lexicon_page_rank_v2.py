...
# python update_lexicon_page_rank_v2.py num_words n_files n_comatrix file_name keyword
...
def generate_files(n_files=7, fname='-'):
    ...
    input:
        ...
        fname: the name of file, it can be a part of the file's name, the default is '-'
...
notLexicon_index = list(set(range(len(list_node)))-set(lexicon_index))
comatrix[:, notLexicon_index] = 0
